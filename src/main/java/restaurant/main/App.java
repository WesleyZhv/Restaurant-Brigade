...
public class App extends Application{
    ...
    private ObservableList<Cuisinier> membres;
    private ObservableList<String> plats;
    private Service serv;
    private HistoriqueService historique;
    private TableView<Cuisinier> tableau;
    ...
    initialiserServices();
        ...
        compteur = new Label("Plats traités : 0");
    ...
    private void initialiserMembres(){
    ...
    private void initialiserServices(){
        ...
        serv = new Service("Service du soir", brigade);

        historique = new HistoriqueService();
    }

    private void configurerBoutons(BorderPane root){
        // Boutons
